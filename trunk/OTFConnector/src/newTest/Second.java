...
public class Second {
	public static void main(String[] args) {
		CompoundTerm comp = new Plug(new Plug(new Trans("vm://start",String.class,"vm:end",Second.class, "setContent"),new Prod("vm:start", String.class, "Ciao")),new Cons("vm:end",String.class));
		comp.start();
		try {
			Thread.sleep(3000);
