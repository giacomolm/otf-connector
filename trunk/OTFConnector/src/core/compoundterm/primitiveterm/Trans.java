...
public class Trans extends PrimitiveTerm{
	...
	public Trans(final String sourceUri, Class in_type, final String receiverUri){
		super(new Port(sourceUri,in_type,order), new Port(receiverUri,null,order));
	...
	public Trans(final String sourceUri, Class in_type,final String receiverUri,Class method_class, String method_name){
		super(new Port(sourceUri,in_type,order), new Port(receiverUri,null,order));
